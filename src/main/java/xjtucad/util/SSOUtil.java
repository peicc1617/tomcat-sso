...
public class SSOUtil {
    ...
    public static String result2String(Result result){
        ...
        sb.append(getString("state")).append(':').append(getString(result.isState()?"true":"false")).append(',');
        sb.append(getString("content")).append(':').append(getString(result.getContent())).append('}');
        return sb.toString();
    }
